...
public class PemainLawanAdapter extends RecyclerView.Adapter<PemainLawanAdapter.ProfileBlogViewHolder> {
    ...
    public PemainLawanAdapter(Context context, List<Pemains> pemain_list) {
    ...
    @NonNull
    @Override
    public PemainLawanAdapter.ProfileBlogViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final PemainLawanAdapter.ProfileBlogViewHolder holder, final int position) {
...
//                        builder.show();
                ...
                alertbox.setItems(new String[]{"Lihat Profil Pemain"}, new DialogInterface.OnClickListener() {
                    @Override
    ...
    public class ProfileBlogViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView popUpNamaPemin, popUpUmurPemain, popUpPrestasiPemain;
        ...
        public void showDataPopUpProfile(String popupName) {
            ...
            popUpPrestasiPemain = mDialog.findViewById(R.id.popup_user_prestasi);
            ...
            firebaseFirestore.collection("Pemain").document(popupName).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                ...
                public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                    if (documentSnapshot.exists()) {
                        ...
                        popUpPrestasiPemain.setText(prestasi);
